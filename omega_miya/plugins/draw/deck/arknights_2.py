...
ALL_OPERATOR: List[Operator] = [
    ...
    Operator(name="黑键/Elenholz", star=6, limited=False, recruit_only=False, event_only=False, special_only=False),
    Operator(name="濯尘芙蓉/Hibiscus the Purifier", star=5, limited=False, recruit_only=False, event_only=False, special_only=True),
    ...
    Operator(name="归溟幽灵鲨/Specter the Unchained", star=6, limited=True, recruit_only=False, event_only=False, special_only=True),
    ...
    Operator(name="寒芒克洛丝/Kroos the Keen Glint", star=5, limited=False, recruit_only=False, event_only=True, special_only=True),
    Operator(name="九色鹿/Nine-Colored Deer", star=5, limited=True, recruit_only=False, event_only=True, special_only=False),
    Operator(name="暮落/Shalem", star=5, limited=False, recruit_only=False, event_only=True, special_only=False),
    Operator(name="灵知/Gnosis", star=6, limited=False, recruit_only=False, event_only=False, special_only=False),
    ...
    Operator(name='正义骑士号/"Justice Knight"', star=1, limited=False, recruit_only=True, event_only=False, special_only=False),
...
def draw_ten_arknights_2(user_id: int) -> str:
    # 获得当期up干员
    up_operators = []
    for item in [x.operator for x in UP_OPERATOR]:
        up_operators.extend([f"【{x.star}☆】{x.name}" for x in item])
